...
export function FeedbackPage() {
    ...
    return (
        <>
            {comments.length > 0 ? (
                <main className="overflow-y-auto p-2 md:p-5 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-2 grid-flow-row max-h-[85%]">
                    ...
                    {modalIsShow && selectedFeedback && (
                        ...
                        >
                            <div
                                ...
                                className='w-screen sm:max-w-[500px]'
                            >
                ...
                <div className='w-full h-[80%] flex items-center justify-center animate-pulse'>não há nenhum comentário na seção de avaliações do seu site</div>
            )}
        </>
    )
}